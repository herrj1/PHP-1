...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-12" style="margin:10px 0px ">
			...
			<form action="<?php echo base_url()."index.php/dashboard/editUser/".$userInfo['id']?>" method="post">
				<div class="form-group custom-bottom-margin">
					<label class="control-label col-sm-4 text-right" for="name">First Name</label>
					<div class="col-sm-5">
					  <input type="text" name="first_name" class="form-control" value="<?php echo $userInfo['first_name'] ?>" placeholder="Enter First name" id="fname">
					</div>
				</div>
				<div class="form-group custom-bottom-margin">
					<label class="control-label col-sm-4 text-right" for="name">Last Name</label>
					<div class="col-sm-5">
					  <input type="text" name="last_name" class="form-control" value="<?php echo $userInfo['last_name']; ?>" placeholder="Enter Last name" id="lname">
					</div>
				</div>
				<div class="form-group custom-bottom-margin">
					<label class="control-label col-sm-4 text-right" for="email">Email</label>
					<div class="col-sm-5">
					  <input type="email" name="email" class="form-control" value="<?php echo $userInfo['email'];?>" placeholder="Enter email" id="email">
					</div>
				</div>
				...
				<div class="form-group custom-bottom-margin">
					...
					<div class="col-sm-5">
					  <input type="password" name="password" class="form-control" placeholder="Update password" id="password">
					</div>
				</div>
				...
				<div class="form-group custom-bottom-margin">
					...
					<div class="col-sm-5">
					  <input type="text" name="phone" class="form-control" value="<?php echo $userInfo['phone'];?>" placeholder="Enter phone" id="phone">
					</div>
				</div>
